...
import { Button, Card, Input } from '@nex-rural/ui';

import { useAuth } from '@/hooks/useAuth';

// Perfis iniciais de acesso oferecidos no cadastro.
const roleOptions = [
...
const defaultRole = roleOptions.at(0)?.value ?? 'PRODUTOR';
    ...
    <Card className="mx-auto w-full max-w-[560px] space-y-6 p-7 sm:p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <select
            id="signup-role"
            className="h-10 w-full rounded-lg border border-border bg-white px-3 text-sm text-foreground outline-none transition focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/30"
            value={role}
