...
import { Button, cn } from '@nex-rural/ui';
    ...
    >
      <span
        className={cn(
          ...
          active ? 'border-primary/35 bg-primary/15 text-primary' : 'border-border bg-white text-muted-foreground'
        )}
      >
        {glyph}
      </span>
  ...
  return (
    <aside className="surface h-fit p-4">
      <div className="space-y-5">
        <div className="space-y-2 rounded-xl border border-border/80 bg-background/55 px-3 py-3">
        ...
        <div className="space-y-2 rounded-xl border border-border/70 bg-background/55 px-3 py-3 text-sm text-muted-foreground">
